    ...
    return (
        <div className="w-full bg-white rounded-[12px] h-fit">
            ...
            <div className="p-[20px] flex flex-wrap">
                ...
                <div className="w-full justify-start flex mt-[10px] font-sans font-semibold text-start">
                    {title}
                </div>
                <div className="w-full h-fit bg-black rounded-[12px] mt-[10px] flex justify-center items-center">
                    <ReactPlayer url={url} className="react-player" controls volume={1} />
                </div>
                <div className="w-full mt-[10px] flex justify-between">
                    <button className="flex items-center" onClick={() => setModal({ ...modal, like: true })}>
                        <LikeFilled className="text-[#9d4edd] text-[16px] mr-[4px]" />
                        You and 1 more
                    </button>
